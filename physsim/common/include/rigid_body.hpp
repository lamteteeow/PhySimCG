...
namespace physsim
{
    ...
    public:
        ...
        /**
         * @brief Gets the shape that is associated with this rigid body.
         * @return Shape that is associated with this rigid body.
         */
        std::shared_ptr<const vislab::Shape> shape() const;

        /**
         * @brief Sets the shape that is associated with this rigid body.
         * @param shape Shape that is associated with this rigid body.
         */
        void setShape(std::shared_ptr<vislab::Shape> shape);
    ...
    private:
        ...
        /**
         * @brief Shape that is associated with this rigid body.
         */
        std::shared_ptr<vislab::Shape> mShape;
