...
namespace physsim
{
    ...
    public:
         ...
         */
        size_t closestPoints(const typename ArrayType::Element& point, const Eigen::Index& numPnts, uint32_t* outputIndices, typename ArrayType::Scalar* outputDistances)
        {
            if (mArray == nullptr)
                return 0;
         ...
         * @return Actual number of closest points that have been found.
         */
        size_t closestRadius(const typename ArrayType::Element& point, const typename ArrayType::Scalar& radius, RadiusResult& output)
        {
            if (mArray == nullptr)
                return 0;
    ...
    private:
        ...
        struct PointCloud
        {
             ...
             */
            inline size_t kdtree_get_point_count() const { return mArray.getSize(); }
             ...
             * @return L2 distance.
             */
            inline typename ArrayType::Scalar kdtree_distance(const typename ArrayType::Scalar* p1, const size_t idx_p2, size_t size) const
            {
