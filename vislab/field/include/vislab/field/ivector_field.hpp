...
namespace vislab
{
    ...
    public:
         ...
         */
        double sampleMagnitude(const DomainCoord& coord) const
        {
         ...
         */
        double sampleDivergence(const DomainCoord& coord) const
        {
         ...
         */
        Matrix sampleJacobian(const DomainCoord& coord) const
        {
            Matrix jacobian;
         ...
         */
        Vector sampleAcceleration(const DomainCoord& coord) const
        {
         ...
         */
        Matrix sampleStrainRateTensor(const DomainCoord& coord) const
        {
            Matrix J = sampleJacobian(coord);
         ...
         */
        Matrix sampleVorticityTensor(const DomainCoord& coord) const
        {
            Matrix J = sampleJacobian(coord);
            return (J - J.transpose()) / 2;
        }
         ...
         */
        double sampleSwirlingStrength(const DomainCoord& coord) const
        {
            Matrix J         = sampleJacobian(coord);
         ...
         */
        double sampleEigenvaluesAreComplex(const DomainCoord& coord) const
        {
         ...
         */
        Vector sampleEigenvaluesRealParts(const DomainCoord& coord) const
        {
            Matrix J    = sampleJacobian(coord);
         ...
         */
        double sampleDeterminantJacobian(const DomainCoord& coord) const
        {
