...
namespace vislab
{
    ...
    public:
         ...
         */
        ConstantBufferOpenGL(const ConstantBufferOpenGL& other)
            : data(other.data)
            , mBuffer(-1)
        {
        }
         ...
         */
        ~ConstantBufferOpenGL() { releaseDevice(); }
         ...
         */
        bool bind(unsigned int shaderProgram, const char* blockName, int bindingPoint)
        {
