...
namespace vislab
{
    ...
    public:
         ...
         */
        RenderWindowOpenGL(int width, int height, const char* title, bool fullScreen = false);
         ...
         */
        [[nodiscard]] const OpenGL* getOpenGL() const;
    ...
    protected:
        ...
        virtual bool createDevice(OpenGL* opengl);
         ...
         * @return True, if the creation succeeded.
         */
        virtual bool createSwapChain(OpenGL* opengl);
    ...
    private:
         ...
         */
        bool initWindow(int width, int height, const char* title, bool fullScreen);
    ...
    protected:
         ...
         */
        GLFWwindow* getGlwfWindow() { return mWnd; }
