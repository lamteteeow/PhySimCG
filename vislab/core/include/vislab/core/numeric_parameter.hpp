...
namespace vislab
{
    ...
    class NumericParameter : public Parameter<TValueType>
    {
        VISLAB_OBJECT(NumericParameter, Parameter<TValueType>)
    ...
    public:
         ...
         */
        virtual void setValue(const TValueType& value, bool notifyOnChange = true) override
        {
         ...
         */
        const TValueType& getMinValue() const { return mMinValue; }
         ...
         */
        const TValueType& getMaxValue() const { return mMaxValue; }
